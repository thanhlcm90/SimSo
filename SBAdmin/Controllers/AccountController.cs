    ...
    public class AccountController : Controller
    {
        ...
        public async Task<JsonResult> SignIn(LoginViewModel model)
        {
            ...
            switch (result)
            {
                ...
                case SignInStatus.LockedOut:
                    return Json("Lock out!", JsonRequestBehavior.AllowGet);
                case SignInStatus.Failure:
                default: return Json("Username or password is not correct!", JsonRequestBehavior.AllowGet);
            }
        }
        ...
        //    return Json(context.Roles.ToList(), JsonRequestBehavior.AllowGet);
        //}
